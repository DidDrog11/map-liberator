...
- **`mod_controls.R`** — the largest module. Owns project metadata, country/level selection, admin-level filters, and the data-loading pipeline. Returns `geom_data`, `context_data`, `geom_trigger`, `metadata`, `add_trigger`, `clear_trigger`.
